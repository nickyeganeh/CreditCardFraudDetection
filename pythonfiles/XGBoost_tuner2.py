...
# TRAIN AND TEST DATA
pipeline_X_train = pd.read_csv("../train-test_data/pipeline_X_train2.csv")
pipeline_y_train = pd.read_csv("../train-test_data/pipeline_y_train2.csv").fraud
...
print("<<< SAVING GRID >>>")
# SAVE MODEL
joblib.dump(grid, 'xgbc_grid2.pk1')
print("<<< GRID SAVED >>>")
print("<<< DONE >>>")